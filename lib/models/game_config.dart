...
class EnhancedGameConfig {
  ...
  factory EnhancedGameConfig.fromJson(Map<String, dynamic> json) {
    return EnhancedGameConfig(
      gridSize: json['gridSize'] as int? ?? 10,
      entropyThreshold: (json['entropyThreshold'] as num?)?.toDouble() ?? 0.8,
      maxSectors: json['maxSectors'] as int? ?? 100,
  ...
  EnhancedGameConfig copyWith({
    ...
    return EnhancedGameConfig(
      ...
      maxSectors: maxSectors ?? this.maxSectors,
